...
const ServicioContainer = () => {
                ...
                <div key={card.servicio}>
                    <div className={style.carrusel}>
                      ...
                      <div className={style.mitexto}>
                        <h2 className={headline}><span>{card.servicio.split(' ')[0]}</span> {card.servicio.split(' ').slice(1).join(' ')}</h2>
                        <p className={body}>
                          {card.body}
                        </p>
                        <div className={style.botones}>
                          <button className={'botonBorder ' + label}><a href="/servicios">Más</a></button>
                          <button className={'botonFull ' + label}><a href="/contacto">Contáctenos</a></button>
                        </div>
                      </div>
                    </div>
                </div>
  ...
  let caca = [
    ...
    },
    {
      ...
      img: 'https://rotom.es/media/mageplaza/blog/post/import/blog/es/2021/03/palets-de-madera-de-un-solo-uso-pueden-utilizarse-mas-de-una-vez/palets-de-madera-de-un-solo-uso-pueden-utilizarse-mas-de-una-vez-2.jpg',
    },
    {
