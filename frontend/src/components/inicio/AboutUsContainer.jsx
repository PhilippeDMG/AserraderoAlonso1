      ...
      <div className={style.izquierda}>
        <div className={style.texto}>
          ...
          <p className={body}>
            ...
            <b>Además</b> de nuestro enfoque en el tratado fitosanitario, también ofrecemos una amplia gama de productos de alta calidad. Desde <p>pallets</p> robustos y confiables hasta <b>tablas aserradas</b> duraderas, brindamos soluciones adaptadas a las necesidades específicas de nuestros clientes. <br />
