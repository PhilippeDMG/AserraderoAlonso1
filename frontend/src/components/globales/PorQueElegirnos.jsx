      ...
      <div className={style.micuadro}>
        <div className={style.calidad}>
          ...
          <div className={style.contenedor}>
            ...
            <div className={body}>Protección confiable para pallets y tablas: Seguridad garantizada en nuestro tratamiento fitosanitario de aserradero.</div>
          </div>
        </div>
        <div className={style.calidad}>
          ...
          <div className={style.contenedor}>
            ...
            <div className={body}>Experiencia en cada paso: Nuestro aserradero brinda conocimientos sólidos en tratamientos fitosanitarios para pallets y tablas.</div>
          </div>
        </div>
        <div className={style.calidad}>
          <img
          ...
          <div className={style.contenedor}>
            ...
            <div className={body}>Confíe en nuestro aserradero: Garantizamos tratamientos fitosanitarios confiables y de calidad para pallets y tablas.</div>
          </div>
        </div>
        <div className={style.calidad}>
          ...
          <div className={style.contenedor}>
            ...
            <div className={body}>Maximice la eficiencia en su producción: Nuestro aserradero ofrece tratamientos fitosanitarios rápidos y eficientes para pallets y tablas.</div>
          </div>
        </div>
      </div>
    </div>
